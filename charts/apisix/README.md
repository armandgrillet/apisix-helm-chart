...
| etcd | object | `{"auth":{"rbac":{"create":false,"rootPassword":""},"tls":{"certFilename":"","certKeyFilename":"","enabled":false,"existingSecret":"","sni":"","verify":true}},"autoCompactionMode":"periodic","autoCompactionRetention":"1h","containerSecurityContext":{"enabled":false},"enabled":true,"image":{"repository":"bitnamilegacy/etcd"},"prefix":"/apisix","replicaCount":3,"service":{"port":2379},"timeout":30,"volumePermissions":{"image":{"repository":"bitnamilegacy/os-shell"}}}` | etcd configuration use the FQDN address or the IP of the etcd |
...
| etcd.image | object | `{"repository":"bitnamilegacy/etcd"}` | Note: etcd images have been overridden to use bitnamilegacy instead of bitnami |
